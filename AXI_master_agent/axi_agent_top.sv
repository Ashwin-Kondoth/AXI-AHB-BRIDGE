class axi_rst_agent_top extends uvm_env;
	...
	axi_rst_agent axi_rst_agt[];
	
	extern function void build_phase(uvm_phase phase);	

endclass : axi_rst_agent_top

	
function void axi_rst_agent_top::build_phase(uvm_phase phase);
	if(!uvm_config_db #(env_config)::get(this,"","env_config",cfg))
		`uvm_fatal("AXI_RST_AGT_TOP","Get failed for env_config")
	
	axi_rst_agt = new[cfg.num_axi_agent];	
